...
Goldie apresentou a meta do próximo trimestre à diretoria: **15% de redução no custo cloud** até o fim do período, **sem degradar SLA**. Doc Brown pegou o breakdown de custos AWS do último mês e repassou a análise inicial para o time.

## Dados (CSV)

Arquivo de referência: [`custos-aws.csv`](custos-aws.csv)
...
O relatório que volta para Goldie precisa trazer:
...
Aplicando o framework **T-A-G**, escrever o prompt de IA que, a partir do CSV acima, produza esse relatório alinhado à meta de **15%**.
...
| **Output** | Relatório de redução de custos (e artefatos relacionados) |
