...
- API **Python/Flask** na porta `8080`
- Dependências declaradas em `requirements.txt`
- Duas variáveis de ambiente obrigatórias no runtime: `DATABASE_URL` e `API_KEY`
...
Aplicando o framework **R-T-F**, escrever o prompt de IA que produza esse Dockerfile.
...
| **Output** | Dockerfile (e artefatos relacionados, se aplicável) |
